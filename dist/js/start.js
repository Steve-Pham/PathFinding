...
import DFS from './algorithms/DFS.js'; // Initialize Grid/Maze

let maze = new Grid(26, 60); // Search Button DOM

let searchButton = document.getElementById('search'); // Reset Button DOM

let resetButton = document.getElementById('reset'); // Starting Node

let startingNode; // Ending Node

let endingNode; // This is the drop down menu value, BFS or DFS 

let dropDownValue = ''; // These are the default starting node/ending node locations
